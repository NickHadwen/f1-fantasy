...
def seed_data():
    ...
    drivers = [
        ...
        ("Isack Hadjar",        "Red Bull",      10.0,  6, "FRA"),
        ("Lewis Hamilton",      "Ferrari",       26.0, 44, "GBR"),
        ("Charles Leclerc",     "Ferrari",       25.0, 16, "MON"),
        ("Lando Norris",        "McLaren",       28.0,  1, "GBR"),
        ("Oscar Piastri",       "McLaren",       23.0, 81, "AUS"),
        ("George Russell",      "Mercedes",      23.0, 63, "GBR"),
        ("Kimi Antonelli",      "Mercedes",      14.0, 12, "ITA"),
        ("Fernando Alonso",     "Aston Martin",  11.0, 14, "ESP"),
        ("Lance Stroll",        "Aston Martin",   8.0, 18, "CAN"),
        ("Pierre Gasly",        "Alpine",        11.0, 10, "FRA"),
        ("Franco Colapinto",    "Alpine",         8.0, 43, "ARG"),
        ("Liam Lawson",         "Racing Bulls",  13.0, 30, "NZL"),
        ("Arvid Lindblad",      "Racing Bulls",   6.0, 41, "GBR"),
        ("Nico Hulkenberg",     "Audi",          10.0, 27, "GER"),
        ("Gabriel Bortoleto",   "Audi",           7.0,  5, "BRA"),
        ("Alexander Albon",     "Williams",      12.0, 23, "THA"),
        ("Carlos Sainz",        "Williams",      16.0, 55, "ESP"),
        ("Oliver Bearman",      "Haas",           9.0, 87, "GBR"),
        ("Esteban Ocon",        "Haas",          10.0, 31, "FRA"),
        ("Sergio Perez",        "Cadillac",       9.0, 11, "MEX"),
        ("Valtteri Bottas",     "Cadillac",       8.0, 77, "FIN"),
    ]

    constructors_data = [
        ("Red Bull",      26.0, "#3671C6"),
        ("Ferrari",       27.0, "#E8002D"),
        ("McLaren",       28.0, "#FF8000"),
        ("Mercedes",      22.0, "#27F4D2"),
        ("Aston Martin",  12.0, "#229971"),
        ("Alpine",        10.0, "#FF87BC"),
        ("Racing Bulls",  10.0, "#6692FF"),
        ("Audi",           9.0, "#ff0000"),
        ("Williams",      13.0, "#64C4FF"),
        ("Haas",           9.0, "#B6BABD"),
        ("Cadillac",       7.0, "#c0a44d"),
    ]
